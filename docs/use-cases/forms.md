...
FormType can use components from blidnet devkit to allow their clients to view Privacy Request, and act upon Privacy Request Response recommendations generated by Privacy Computation Engine.
